namespace POS
{
    partial class vw_SanPham
    {
        ...
        private void InitializeComponent()
        {
            ...
            btn_DenViewChiTietDonHang = new Button();
            ...
            lb_TenSanPham.Font = new Font("Showcard Gothic", 13.8F, FontStyle.Bold, GraphicsUnit.Point, 0);
            lb_TenSanPham.Location = new Point(255, 70);
            lb_TenSanPham.Name = "lb_TenSanPham";
            lb_TenSanPham.Size = new Size(95, 29);
            ...
            lb_Gia.Location = new Point(83, 159);
            lb_Gia.Name = "lb_Gia";
            ...
            // num_SoLuong
            // 
            num_SoLuong.Location = new Point(83, 206);
            ...
            // 
            // btn_DenViewChiTietDonHang
            // 
            btn_DenViewChiTietDonHang.BackColor = Color.FromArgb(128, 255, 128);
            btn_DenViewChiTietDonHang.Location = new Point(604, 316);
            btn_DenViewChiTietDonHang.Name = "btn_DenViewChiTietDonHang";
            btn_DenViewChiTietDonHang.Size = new Size(162, 29);
            btn_DenViewChiTietDonHang.TabIndex = 6;
            btn_DenViewChiTietDonHang.Text = "Thêm vào đơn hàng";
            btn_DenViewChiTietDonHang.UseVisualStyleBackColor = false;
            btn_DenViewChiTietDonHang.Click += btn_DenViewChiTietDonHang_Click;
            // 
            // btn_ThemSanPhamKhac
            // 
            btn_ThemSanPhamKhac.BackColor = SystemColors.ActiveCaption;
            btn_ThemSanPhamKhac.Location = new Point(604, 368);
            ...
            Controls.Add(btn_DenViewChiTietDonHang);
            Controls.Add(rbtn_L);
            Controls.Add(rbtn_M);
            Controls.Add(rbtn_S);
        ...
        private Button btn_DenViewChiTietDonHang;
